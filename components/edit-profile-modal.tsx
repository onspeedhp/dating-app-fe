...
export function EditProfileModal({ open, onClose, user, onSave }: EditProfileModalProps) {
  ...
  const validateForm = () => {
    ...
    else if (Number.parseInt(formData.age) < 18) newErrors.age = "You must be 18 or older"
    else if (Number.parseInt(formData.age) > 100) newErrors.age = "Please enter a valid age"
    if (!formData.city.trim()) newErrors.city = "City is required"
    if (!formData.workTitle.trim()) newErrors.workTitle = "Job title or field of study is required"
    if (!formData.bio.trim()) newErrors.bio = "Bio is required"
    else if (formData.bio.length > 160) newErrors.bio = "Bio must be 160 characters or less"
        ...
        <div className="space-y-6 py-4">
          ...
          <div>
            ...
            <div className="flex justify-between items-center mt-2">
              ...
              <p className="text-sm text-muted-foreground ml-auto">{formData.bio.length}/160 characters</p>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-2">Selected: {formData.interests.length} interests</p>
          </div>
