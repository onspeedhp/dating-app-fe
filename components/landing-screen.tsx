  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 flex flex-col">
          ...
          <div className="w-64 h-96 bg-gradient-to-br from-primary/10 to-accent/10 rounded-3xl border border-border/50 shadow-2xl overflow-hidden">
            <div className="p-6 h-full flex flex-col">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-xs font-medium text-muted-foreground">Violet</div>
      ...
      <div className="px-6 pb-8 space-y-3">
        <Button onClick={onSignup} size="lg" className="w-full h-14 text-lg font-semibold rounded-2xl">
          Get Started
        </Button>
        <Button
          onClick={onLogin}
